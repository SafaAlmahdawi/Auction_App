...
public class AcceptRejectCaptainsActivity extends ListActivity {

    ImageView imgHome, imgArrow;
    String uid, name, email, usern, pass;
    String userID ="", userName ="", userEmail ="", userPhone ="", userCity ="";
    Spinner txtSpin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accept_reject_captains);
        ...
        butAccept.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             if(!userID.equals("")){
                                                 ...
                                                 Toast.makeText(getApplicationContext(), "Please choose a Captain to Accept", Toast.LENGTH_SHORT).show();
                                             }
                                         }
                                     }
        );
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                userCity = ((TextView) view.findViewById(R.id.user_address)).getText().toString();
            }
        });
    }
    ...
    class LoadAllUsers extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialogBox = new ProgressDialog(AcceptRejectCaptainsActivity.this);
            dialogBox.setMessage("Read Waiting Captains data .....");
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(vars.url_view_captains2, "GET", params);
            try {
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(AcceptRejectCaptainsActivity.this, users_list,
    ...
    class RejectUser extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialogBox = new ProgressDialog(AcceptRejectCaptainsActivity.this);
            dialogBox.setMessage("Reject the selected Captain ...");
            dialogBox.setIndeterminate(false);
            dialogBox.setCancelable(true);
            dialogBox.show();
        }
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject json = jParser.makeHttpRequest(vars.url_reject_captain, "POST", params);
    ...
    class AcceptUser extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialogBox = new ProgressDialog(AcceptRejectCaptainsActivity.this);
            dialogBox.setMessage("Accept the selected Captain ...");
            dialogBox.setIndeterminate(false);
            dialogBox.setCancelable(true);
            dialogBox.show();
        }
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                List<NameValuePair> params = new ArrayList<NameValuePair>();
                params.add(new BasicNameValuePair("userID", userID));
                JSONObject json = jParser.makeHttpRequest(vars.url_accept_captain, "POST", params);
                Log.d("Delete User", json.toString());
                success = json.getInt(TAG_SUCCESS);
                if (success == 1) {
                    Intent intent = new Intent(getApplicationContext(), AcceptRejectCaptainsActivity.class);
