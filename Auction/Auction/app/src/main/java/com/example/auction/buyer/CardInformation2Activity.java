...
public class CardInformation2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_information2);
    ...
    class ChangeStatus extends AsyncTask<String, String, String> {
        ...
        public void onPreExecute() {
            super.onPreExecute();
            dialogBox = new ProgressDialog(CardInformation2Activity.this);
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject json = jsonParser.makeHttpRequest(vars.url_bid_change_status2, "POST", params);
