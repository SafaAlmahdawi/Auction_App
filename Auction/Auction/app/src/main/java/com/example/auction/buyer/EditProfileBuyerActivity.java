...
import com.example.auction.CreateAccountActivity;
import com.example.auction.DataHandler;
import com.example.auction.LoginActivity;
...
public class EditProfileBuyerActivity extends AppCompatActivity {
    ...
    EditText txtName, txtEmail, txtUser, txtPass, txtPhone, txtAddress, txtPayment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_profile_buyer);
        ...
        butSave.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             ...
                                             if (txtName.getText().toString().equals("") || txtPass.getText().toString().equals("")
                                                 ...
                                                 payment = txtSpin.getSelectedItem().toString() + " - " + txtPayment.getText().toString().trim();
    ...
    class EditProfile extends AsyncTask<String, String, String> {
        ...
        public void onPreExecute() {
            super.onPreExecute();
            dialogBox = new ProgressDialog(EditProfileBuyerActivity.this);
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject json = jsonParser.makeHttpRequest(vars.url_edit_buyer, "POST", params);
